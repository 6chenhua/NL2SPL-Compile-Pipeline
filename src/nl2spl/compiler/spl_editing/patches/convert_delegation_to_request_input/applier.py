"""ConvertDelegationToRequestInput applier disabled after R10 migration."""
...
class ConvertDelegationToRequestInputApplier(PatchApplier):
    ...
    def apply(
        ...
        raise SPLEditingError(
            "ConvertDelegationToRequestInputApplier.apply() is disabled. "
            "ConvertDelegationIntentToRequestInput must go through RepairMaterializationService."
        )
